...
const RecipeGenerator = () => {
  ...
  const handleGenerate = () => {
    // Simulate GPT recipe generation
    setTimeout(() => {
      setRecipe({
  ...
  return (
    <div className="space-y-6">
      <div className="text-center">
        ...
        <p className="text-muted-foreground">Get AI-powered recipes based on your inventory and dietary goals</p>
      </div>
      ...
      <div className="max-w-4xl mx-auto grid md:grid-cols-2 gap-6">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Set your dietary goals and preferences</CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            ...
            <div>
              ...
              <Select onValueChange={(value) => setPreferences(prev => ({ ...prev, diet: value }))}>
                <SelectTrigger>
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-2 mt-2">
                {availableIngredients.map((ingredient) => (
                  <Badge key={ingredient} variant="outline" className="cursor-pointer hover:bg-primary hover:text-primary-foreground">
                    {ingredient}
                  </Badge>
                ))}
              </div>
            ...
            <Button variant="cooking" onClick={handleGenerate} className="w-full">
